...
namespace SheepYourHackHosting
{
    ...
    /// </summary>
    public static class SheepYourHackHostingExtensions
    {
        /// <summary>
        ...
        /// </code>
        /// </example>
        public static void AddNextjsStaticHosting(this IServiceCollection services, Action<SheepYourHackHostingOptions> configureAction = null)
        {
        ...
        /// <summary>
        /// Registers endpoints for Next.js pages found in the configured <see cref="SheepYourHackHostingOptions.RootPath"/>.
        ...
        public static IEndpointConventionBuilder MapNextjsStaticHtmls(this IEndpointRouteBuilder endpoints)
        {
            ...
            var options = endpoints.ServiceProvider.GetRequiredService<IOptions<SheepYourHackHostingOptions>>();
            if (options.Value.ProxyToDevServer)
            {
                ...
                logger.LogInformation($"{nameof(SheepYourHackHostingExtensions)} was configured with {nameof(SheepYourHackHostingOptions.ProxyToDevServer)}, skipping dynamic endpoint configuration.");
        ...
        /// <summary>
        /// Registers a static files middleware that will serve files from the configured <see cref="SheepYourHackHostingOptions.RootPath"/>.
        ...
        public static void UseNextjsStaticHosting(this IApplicationBuilder app)
        {
            ...
            var options = app.ApplicationServices.GetRequiredService<IOptions<SheepYourHackHostingOptions>>();
            if (options.Value.ProxyToDevServer)
            {
