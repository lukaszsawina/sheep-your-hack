...
namespace SheepYourHackHosting.Internals
{
    ...
    {
        private readonly SheepYourHackHostingOptions options;
        private readonly IHttpForwarder yarpForwarder;
        private readonly RequestDelegate next;
        private readonly ILogger<ProxyToDevServerMiddleware> logger;
        private readonly HttpMessageInvoker httpClient;

        public ProxyToDevServerMiddleware(IOptions<SheepYourHackHostingOptions> options, IHttpForwarder yarpForwarder, RequestDelegate next, ILogger<ProxyToDevServerMiddleware> logger)
        {
